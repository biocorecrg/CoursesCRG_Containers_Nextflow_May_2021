...
```{r, out.width="30%", echo=FALSE, fig.link='https://www.nextflow.io'}
knitr::include_graphics('docs/images/nextflow_logo_deep.png')
```

## What is Nextflow?

```{r, out.width="600px", echo=FALSE, fig.link='https://www.nextflow.io'}
...
```{r, out.width="600px", echo=FALSE, fig.link='https://pubmed.ncbi.nlm.nih.gov/28398311/'}
...
```{r, out.width="600px", echo=FALSE, fig.link='https://pubmed.ncbi.nlm.nih.gov/?term=nextflow&timeline=expanded&sort=pubdate&sort_order=asc'}
...
```{r, out.width="800px", echo=FALSE, fig.link='https://tower.nf/'}
