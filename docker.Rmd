...
During this course, we will see a bit about **Ubuntu** and **CentOS**.
...
Use ++docker tag` in order to **tag a local image** that has ID "e23aaea5dff1" into the "ubuntu_wget" image name repository with version/tag "1.0":
