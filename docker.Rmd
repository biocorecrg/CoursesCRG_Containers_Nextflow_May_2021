...
```{block2, type='rdmtip'}
If interested in using Conda, you may be interested in this Docker image: https://hub.docker.com/r/continuumio/miniconda3
```
...
* Add a Dockerfile (any of the ones used in the course). Keep in mind that if the recipe requires files (e.g., processed with **CP**) you will need to upload them and place them in a way compatible with the context you choose.
