...
* We generate a token at https://cloud.sylabs.io/auth/tokens and we use in the command-line below:

    singularity remote login --tokenfile mytokenfile

```{block2, type='rmdtip'}
For safety reasons, remove this token once you use it after the course
```
