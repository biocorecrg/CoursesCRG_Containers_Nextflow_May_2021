...
If you try as normal user:

```
(base) [ec2-user@ip-172-31-32-16 singularity]$ singularity instance start test.sif webserver
...
webserver        24350          /home/ec2-user/git/CoursesCRG_Containers_Nextflow_May_2021/containers/singularity/test.sif
```

If you try with sudo permissions:

```
(base) [ec2-user@ip-172-31-32-16 singularity]$ sudo singularity instance start test.sif webserver
...
INSTANCE NAME    PID      IP    IMAGE
webserver        24409          /home/ec2-user/git/CoursesCRG_Containers_Nextflow_May_2021/containers/singularity/test.sif
```

For this case, it's necessary to allow writing in the image:

```
(base) [ec2-user@ip-172-31-32-16 singularity]$ sudo singularity instance start --writable-tmpfs test.sif webserver
...
```
(base) [ec2-user@ip-172-31-32-16 singularity]$ sudo singularity instance start -B /home/ec2-user/www:/usr/share/nginx/html --writable-tmpfs test.sif webserver
