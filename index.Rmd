...
author:
  - Sarah Bonnin^[CRG, sarah.bonning@crg.eu], Luca Cozzuto^[CRG, luca.cozzuto@crg.eu], Toni Hermoso^[CRG, toni.hermoso@crg.eu], Julia Ponomarenko^[CRG, julia.ponomarenko@crg.eu]
...
tbl_logos <- data.frame(
  name = c("Toni Hermoso", "Luca Cozzuto", "Julia Ponomarenko", "Sarah Bonnin"),
  pic="",
  description=c("", 
                "",
                "",
...
tbl_logos %>%
  ...
  column_spec(2, image = spec_image(
    c("docs/images/thermoso.jpg", "docs/images/lcozzuto.jpg", "docs/images/jponomarenko.jpg", "docs/images/sbonnin.jpg"), width=380, height=270))
