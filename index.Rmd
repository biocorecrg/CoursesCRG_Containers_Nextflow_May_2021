...
You will need to connect during the course to a remote server via the **ssh** protocol: you should be familiar
with it. You can learn about it <a href="https://www.hostinger.com/tutorials/ssh-tutorial-how-does-ssh-work" target="_blank">here</a>.
<br>
