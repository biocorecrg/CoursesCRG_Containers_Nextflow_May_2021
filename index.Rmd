...
Participants will access by SSH to an [Amazon EC2](https://en.wikipedia.org/wiki/Amazon_Elastic_Compute_Cloud) instance dedicated only for themselves. That instance runs [Amazon Linux 2](https://aws.amazon.com/amazon-linux-2/) with all the necessary software used for the course.

Every instance has a S3 bucket storage mounted at /mnt. If you need to save any file after the end of the 2nd day and at the end of the course, copy files there and you can retrieve them using a web browser.

https://bucketname.s3.eu-central-1.amazonaws.com/copiedfile.txt

where bucketname is the name of the directory in /mnt.
