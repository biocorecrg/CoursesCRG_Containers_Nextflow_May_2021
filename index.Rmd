...
Each participant will access using SSH a dedicated [Amazon EC2](https://en.wikipedia.org/wiki/Amazon_Elastic_Compute_Cloud) instance. That instance runs [Amazon Linux 2](https://aws.amazon.com/amazon-linux-2/) with all the necessary software for the course.

Every instance has a S3 bucket storage mounted at /mnt. If you need to save any file after the end of the 2nd day and in the end of the course, copy files there and then you can retrieve them using a web browser.
